...
export class BackendListener {
	...
	public static onSessionLocationUpdate(callback: (payload: SessionLocation) => void): () => void {
	  return BackendListener.inner_listen<SessionLocation>("session_location_update", callback);
	}
