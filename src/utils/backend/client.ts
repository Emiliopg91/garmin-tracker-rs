...
export class BackendClient {
  ...
  // From src-tauri/src/logic/app.rs:163
  ...
  // From src-tauri/src/logic/app.rs:66
  ...
  // From src-tauri/src/logic/app.rs:77
