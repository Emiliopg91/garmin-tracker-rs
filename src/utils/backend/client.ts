...
export class BackendClient {
  ...
  // From src-tauri/src/logic/exercises.rs:76
  ...
  // From src-tauri/src/logic/sessions.rs:99
  ...
  // From src-tauri/src/logic/sessions.rs:48
  ...
  // From src-tauri/src/logic/sessions.rs:164
  ...
  public static setWorkoutStatus(
    workout: string,
    status: boolean,
  ): Promise<void> {
    return BackendClient.inner_invoke("set_workout_status", {
      workout,
      status,
    });
  }
  ...
  public static updateSettingsValue(
    name: string,
    value: string,
  ): Promise<void> {
